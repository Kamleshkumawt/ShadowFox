...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-between gap-7">
      ...
      {/* Profile Icon */}
        <div className="flex flex-col items-center gap-1 pt-2 cursor-pointer group" aria-label="Profile">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
        ...
        <span className="text-[16px] group-hover:text-yellow-600 transition-colors">Profile</span>
      ...
      {/* Cart Icon */}
        <div className="flex flex-col items-center gap-1 cursor-pointer" aria-label="Cart">
          <svg
            viewBox="0 0 20 20"
            fill="none"
            width="20"
  ...
  <NavigationMenuList>
    <NavigationMenuItem>
      ...
      <NavigationMenuContent
       style={{ width: '1410px', maxHeight: '400px', overflowY: 'auto' }}
       ...
       >
        ...
        <div>
          <div className="font-semibold mb-2">Suits & Dress Material</div>
          <NavigationMenuLink>All Suits & Dress Material</NavigationMenuLink>
      ...
      <NavigationMenuContent
       ...
       >
        ...
        <div>
          ...
          <NavigationMenuLink>All Maternity & Feedingwear</NavigationMenuLink>
          <NavigationMenuLink>Maternity Kurtis & Dresses</NavigationMenuLink>
        </div>
