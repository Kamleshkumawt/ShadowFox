...
const Home = () => {
  ...
  const uniqueProducts = useMemo(
    () => getUniqueCategoryProducts(products),
    [products]
  );
  ...
  const filteredProducts = products.filter((product) => {
    ...
    if (
      ...
      !selectedFabrics
        .map((c) => c.toLowerCase().trim())
        .includes(product.material.toLowerCase().trim())
    ) {
      return false;
    }
  ...
  return !isLoading ? (
    ...
    <div className="w-full px-2 bg-white">
      ...
      <div className="w-full h-full flex items-center justify-center ">
        <img
          src="https://rukminim1.flixcart.com/fk-p-flap/1600/660/image/cb7abaa53e8b0fdb.jpg?q=60"
          className="w-92"
          alt="image"
        />
        <img
      ...
      <div className="w-full h-full flex items-center justify-center gap-3 ">
        ...
        <div className="w-[32%] h-[38rem]">
          <img
            ...
            className="object-cover w-full h-full l"
            alt="image"
          />
        </div>
      </div>
