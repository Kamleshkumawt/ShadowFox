...
import {useReturnsGetProductMutation } from '../../store/api/userApi';
   ...
   const [orders, setOrders] = useState([]);
    ...
    useEffect(() => {
      if(data) {
        ...
        setOrders(data.returns);
      }
    }, [data]);

  return !isLoading && (
    <>
      <Title text1="Returned Orders" text2="List" />
...
export default ShowAllReturnsOrders