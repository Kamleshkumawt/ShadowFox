...
const AddProduct = () => {
  ...
  const { data: subCategoriesData } = useGetAllCategoriesByIdQuery(
      category,
      {
  ...
  const handleFormSubmit = async () => {
    try {
      ...
      formData.append("category", subCategoriesData?.categories?.name || "Smartphone" );
    ...
    <>
      ...
      <div className=" flex flex-col sm:flex-row items-start w-full gap-10 mb-10">
        <div className="w-full flex flex-col items-start">
          <h1 className="text-lg font-medium  text-gray-600 py-3 mt-2 border-b border-gray-400/30 w-full">Product,Size and Inventory</h1>
          ...
          <h1 className="text-lg font-medium  text-gray-600 py-3 mt-5 border-b border-gray-400/30 w-full">Product Details</h1>
        ...
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-3">
          ...
          <div className="relative mt-2">
            <input
              ...
              className={inputClass}
            />
            <label htmlFor="manufacturerName" className={labelClass(manufacturerName)}>
              Manufacturer Name
            </label>
          </div>
          ...
          <div className="relative mt-2">
            <input
              ...
              className={inputClass}
            />
            <label htmlFor="manufacturerAdd" className={labelClass(manufacturerAdd)}>
          ...
          <div className="relative mt-2">
            <input
              ...
              className={inputClass}
            />
            <label htmlFor="manufacturerPin" className={labelClass(manufacturerPin)}>
       ...
       <h1 className="text-lg font-medium  text-gray-600 py-3 mt-5 border-b border-gray-400/30 w-full">Other Attributes</h1>
       <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-3">
           {/* Battery Field */}
          <div className="relative ">
            <input
      ...
      <div className="max-w-xl bg-white rounded-sm flex flex-col items-center gap-5">
        <div className="w-full flex flex-col  p-5 gap-5">
          <p className="text-lg font-semibold font-poppins">Images Guidelines</p>
          <div className="flex gap-2 text-sm items-center"><span className="bg-purple-600/40 rounded-full p-1 px-2">1</span>Images with a clear view of the product</div>
          <div className="flex gap-2 text-sm items-center"><span className="bg-purple-600/40 rounded-full p-1 px-2">2</span>Product images should be of good quality</div>
          <div className="flex gap-2 text-sm items-center"><span className="bg-purple-600/40 rounded-full p-1 px-2">3</span>Please add sold images</div>
          <p className="text-lg font-semibold font-poppins">Add images with details of the product</p>
        ...
        {images.length < 4 && <div className="flex items-center">
